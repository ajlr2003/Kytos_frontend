 ...
 *
 * Business Intelligence module. Aggregates data from all Kytos modules and
 * surfaces insights, trends, and anomalies:
 *   - Executive KPI dashboards and drill-down reports.
 *   - Revenue, cost, and margin analytics across time periods.
 *   - Supplier performance benchmarking and procurement intelligence.
 *   - Custom report builder (planned).
 *
 * Data is currently static demo data. Wire up to /api/v1/intelligence/ when ready.
 */
