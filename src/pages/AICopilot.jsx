 ...
 *   - Conversation tab: chat with the AI assistant about sales, finance, operations.
 *   - History tab: browse and resume previous conversations.
 *   - Saved Prompts: reusable prompt templates for common business queries.
 *   - Context tab: inject live Kytos data (invoices, quotes, etc.) into the AI session.
 *   - Citations and Quick Actions panels.
 *
 * Connects to the configured LLM backend (Anthropic / OpenAI) via the FastAPI proxy.
 */
