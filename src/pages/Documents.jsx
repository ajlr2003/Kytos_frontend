 ...
 *
 * Document management module. Provides:
 *   - Centralised document repository with folder hierarchy.
 *   - Upload, categorise, tag, and archive business documents.
 *   - Access control: share documents with specific roles or users.
 *   - Version history and audit trail.
 *
 * Data is currently static demo data. Wire up to /api/v1/documents/ when ready.
 */
