 ...
 *
 * Main dashboard overview page. Displays:
 *   - KPI summary cards (Revenue, Active Customers, Open Invoices, Inventory Value)
 *     with click-to-expand breakdown drawers.
 *   - Interactive Revenue Trend SVG chart with hover tooltip.
 *   - Sales by Category pie chart rendered on HTML5 Canvas.
 *   - Quick Actions panel linking to other modules.
 *   - Recent Activity feed.
 *   - Supplier Quotation & Cost Comparison six-column widget.
 *   - Module grid for navigating to all InfroneX modules.
 *
 * All chart data is currently static (demo). Replace with API calls when
 * the /api/v1/dashboard endpoint is ready.
 */
