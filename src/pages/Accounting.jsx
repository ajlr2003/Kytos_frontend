 ...
 *   - Journal entry creation via modal form (Date, Account, Description, Debit/Credit).
 *   - Financial statement summaries: Balance Sheet, Income Statement, Cash Flow.
 *   - KPI cards: Total Revenue, Expenses, Net Income, Cash Balance.
 *
 * Data is currently static demo data. Wire up to /api/v1/accounting/ when ready.
 */
...
/* ─── Local modal overlay (uses acc-modal-* CSS classes from Accounting.css) ─── */
