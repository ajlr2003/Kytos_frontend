 ...
 *
 * Projects module (placeholder). Will provide:
 *   - Project lifecycle management: initiation, planning, execution, closure.
 *   - Task boards, time tracking, and resource allocation.
 *   - Field service scheduling and technician dispatch.
 *
 * Currently renders a coming-soon shell. Wire up to /api/v1/projects/ when ready.
 */
