 ...
 *   - Lead pipeline with Kanban-style stage columns.
 *   - Add Lead modal with company, contact, and deal-value capture.
 *   - CRM KPI summary: total leads, pipeline value, win rate, conversion rate.
 *   - Activity feed and follow-up task management.
 *
 * Data is currently static demo data. Wire up to /api/v1/crm/ when ready.
 */
