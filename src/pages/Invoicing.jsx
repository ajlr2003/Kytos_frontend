 ...
 *
 * Invoicing module. Handles customer and supplier invoice management:
 *   - Invoice list with status filtering (Draft, Sent, Paid, Overdue).
 *   - New Invoice modal with client, amount, due date, and description.
 *   - KPI cards: total invoiced, received, outstanding, overdue.
 *   - Quick-send and mark-paid actions directly from the list.
 *
 * API base: /api/v1/invoices/ (stub — wire up when endpoint is ready).
 */
